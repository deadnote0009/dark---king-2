...
async def pmPermit(client: USER, message: Message):
    keyboard = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(text="⚜ Master ⚜", url=f"https://t.me/itzyournil")   
            ]
        ]
    )
    if PMPERMIT == "ENABLE":
        if PMSET:
            ...
            await message.reply_photo(
                ...
                caption="This Is Music Bot Assistant If U Want To Talk With My Master kindly send a message at @itzyournil",
            )
            return
